  ...
  return (
    <section className="container">
      <div className="search-container">
        ...
        <SearchInputComponent searchValue={searchValue} handleChange={handleOnChange} />
      </div>
      {filteredPosts.length > 0 && <PostsComponent posts={filteredPosts} />}
      {filteredPosts.length === 0 && <p className="no-more-posts">Não existem Posts =(</p>}
      <div className="button-container">
        {!searchValue && <ButtonComponent text="Load more posts" whenClick={loadMorePosts} disabled={noMorePosts} />}
      </div>
    </section>
  );
};
